...
klima <- c("*klima*", "fridays for future", "letzte generation", "extinction rebellion","erderwärmung","erderhitzung","pariser-abkommen","pariser-konvention", "*treibhaus*","energiekrise")
