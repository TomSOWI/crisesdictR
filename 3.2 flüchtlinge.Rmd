...
#"*integration*"
#refugee <- c("*flüchtling*", "*einwanderung*","*migra*","*asyl*")
#refugee <- c("*flüchtling*", "*einwanderung*","*migra*","*asyl*","*integration*")
refugee <- c("*flüchtlinge*", "*einwanderung*","migration","asyl","integration")

#asyl eventuell rausnehmen
```
...
cor(dfVal$refugee, dfCor$Flüchtlinge)
